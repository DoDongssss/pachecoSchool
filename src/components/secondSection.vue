         ...
         <div class="w-1/2">
            <div class="flex flex-col">
               ...
               <h2 class="mt-4">
                  ...
                  esse ipsum, excepturi assumenda earum obcaecati cupiditate!
                  Totam eos doloribus corrupti tempora sapiente, rem recusandae
                  eaque itaque magni nisi! Sapiente doloremque
               </h2>
            </div>
